...
**S12 — We Already Split Those Jobs** (4): nothing says one good has to do all three jobs — people quietly split them → the household beat: paid and priced in one money, savings somewhere else → Argentina, five decades — the dated-fact grammar landing on the split → the principle: the jobs are separable, so is there an order?
