...
// The near-16:9 family (1672×941 — fiat, metals, and, since the rail-states
// session of 1 September 2026, the regenerated gold): the recorded height and
// centre applied to the render's own aspect gives 960×540 at (480, 380) —
// 16:9 to within 0.05% of the frame, the ledger_glow transcription repeated.
function formWide(st, name, alt) {
  return df(st, name, FORM_CX - 480, FORM_CY - 270, 960, 540, { alt });
}
...
cell('p1-b5', {
  beat: 'P1 beat 5', status: 'approved', decision: null,
  caption: 'Beat 5 · GOLD · RE-RENDERED AT THE RAIL-STATES SESSION (1 Sep 2026) — the gold study was regenerated by the presenter at 1672×941 and re-ingested, and every box that displays gold derives from the new render’s own aspect; the form box becomes 960×540 at (480, 380), the ledger_glow transcription repeated. The treatment is unchanged — the approved P1-F2 geometry (height 540, centre 960×650) applied to the render that now exists. Was: carried byte-identical from p1-f2 (approved 25 Aug 2026), whose bytes remain at tag batch-b'
}, (st) => {
  formWide(st, 'gold', 'A gold bar emerging from darkness');
});
