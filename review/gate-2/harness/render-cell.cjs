// Gate 2 — render one beat-state cell through the states pipeline
// (states.mjs on the dev server page), full-size, into review/gate-2/states/.
// The single-cell path of capture-states.cjs, for markup re-renders that must
// not disturb the archived sheet.
//
// Usage: node render-cell.cjs --cell s4-b2-b2 [--port 5273]
