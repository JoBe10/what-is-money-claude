// Act II — the scene-module contract, in one place.
//
// The same contract mechanics as Act I's `_sceneModule.js` (master §8.1),
// bound to this act's shared stage:
//
...
import { ensureStage, destroyStage, TOTAL_BUILDS, reducedMotion } from './_architectureStage.js';
