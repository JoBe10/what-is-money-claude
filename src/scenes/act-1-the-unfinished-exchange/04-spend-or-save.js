// Scene 4 — Spend or Save (5 beats), in SYSTEM B's grammar throughout
// (presenter-ruled 27 August 2026, D7-B): one claim at the fork's apex, two
// mirrored roads descending from it, dot terminals, the unchosen road dormant
// rather than absent — the legacy 4.05's symmetric-fork lesson spoken in the
// film's own line language.
//
// TRANSPLANTED FROM THE CLOSED GATE: `src/proto/gate-2/s4-spend-or-save.js`,
// unchanged. This scene carried no runtime candidate, so the transplant is
// verbatim but for its imports.
//
...
// approvedSetCurrent): s4-b1-b · s4-b2-b2 · s4-b3-b · s4-b4-b · s4-b5-b. Beat
// 2 is the presenter's 28 August containment markup — goods at reduced uniform
// scale, a compact triangle wholly inside the left third — approved at the
// gate's close; the claim's travel and redemption motion are unchanged.
