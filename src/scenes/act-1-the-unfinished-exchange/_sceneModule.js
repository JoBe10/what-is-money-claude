// Act I — the scene-module contract, in one place.
//
// TRANSPLANTED FROM THE CLOSED GATE: `src/proto/gate-2/_scene.js`, unchanged
// but for the prototype's scratch-route key. The three scenes differ only in
// their states, gestures and notes; the contract mechanics (master §8.1) are
// identical and live here so they can be wrong in at most one place:
//
...
import { ensureStage, destroyStage, TOTAL_BUILDS, reducedMotion } from './_exchangeStage.js';
