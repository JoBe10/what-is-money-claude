// Act III — the scene-module contract, in one place.
//
// The same contract mechanics as Act I's and Act II's `_sceneModule.js`
// (master §8.1), bound to this act's shared stage:
//
